    ...
    return (
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="flex flex-col lg:flex-col md:flex-row">
          <Image src={imageSrc} width={400} height={400} alt={title} className="w-full h-60 object-cover md:w-1/2 lg:w-full" />
  ...
  return (
    ...
    <div className="container mx-auto p-4 sm:p-8 md:p-12">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <Card
          imageSrc="/munkagep.jpg"
          title="Munkagép Bérlés"
