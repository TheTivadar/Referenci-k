...
interface Props {
    fuvarozasSzolgaltatas2: KontenerTipus[];
}

const FuvarozasDesc1 = ({ fuvarozasSzolgaltatas2 }: Props) => {
  if (!fuvarozasSzolgaltatas2) return null;
  const title1 = fuvarozasSzolgaltatas2.find(item =>item.id === "1")?.title;
  const body2 = fuvarozasSzolgaltatas2.find(item => item.id === "2")?.body;
  const title2 = fuvarozasSzolgaltatas2.find(item =>item.id === "2")?.title;
  const body3 = fuvarozasSzolgaltatas2.find(item => item.id === "3")?.body;
  const title3 = fuvarozasSzolgaltatas2.find(item =>item.id === "3")?.title;
  const body4 = fuvarozasSzolgaltatas2.find(item => item.id === "4")?.body;
  const title4 = fuvarozasSzolgaltatas2.find(item =>item.id === "4")?.title;
