...
var query_validator_1 = require("../lib/validator/query-validator");
...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure.input(zod_1.z.object({
        ...
        var query, cursor, sort, limit, queryOpts, page, payload, parsedQueryOpts, _c, items, hasNextPage, nextPage;
        var input = _b.input;
